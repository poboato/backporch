...
public class AcmeController : ControllerBase
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AcmeController"/> class.
    /// </summary>
    ...
    [HttpGet("Status")]
    public ActionResult<AcmeStatusDto> GetStatus()
    {
        var config = Plugin.Instance!.Configuration;

        return Ok(new AcmeStatusDto
        {
    ...
    [HttpPost("Request")]
    public async Task<ActionResult<AcmeStatusDto>> RequestCertificate(CancellationToken cancellationToken)
    {
